...
{
	//convert multibody/rigidbody

	//split constraints

	//iterate over all blocks
	//call block getSolverSpecificData(...)

	//iterate over all GS iterations
	//for each block
	//block->solveSingleIterationsNew(...)

	//for each block
	//block->newFinalize()

	//convert solver body to multibody/rigidbody
}
