  ...
  foreach(_CURRENT_VERSION IN LISTS _PYTHON_VERSIONS)
    ...
    foreach(_CURRENT_PYTHON_NAME IN LISTS _PYTHON_NAMES)
      ...
      if(_PYTHON_EXECUTABLE)
        ...
        message(STATUS "[DEBUG] _PYTHON_EXECUTABLE: ${_PYTHON_EXECUTABLE}")
        message(STATUS "[DEBUG] _FIND_LIB_PYTHON_PY: ${_FIND_LIB_PYTHON_PY}")

        EXECUTE_PROCESS(
          COMMAND "${_PYTHON_EXECUTABLE}" "--version"
          OUTPUT_VARIABLE _PYTHON_CONFIG2
          RESULT_VARIABLE _PYTHON_CONFIG_RESULT2
          ERROR_QUIET)

        message(STATUS "[DEBUG] _PYTHON_CONFIG_RESULT2: ${_PYTHON_CONFIG_RESULT2}")
        message(STATUS "[DEBUG] _PYTHON_CONFIG2: ${_PYTHON_CONFIG2}")
        ...
        message(STATUS "[DEBUG] _PYTHON_CONFIG_RESULT: ${_PYTHON_CONFIG_RESULT}")
        message(STATUS "[DEBUG] _PYTHON_CONFIG: ${_PYTHON_CONFIG}")
